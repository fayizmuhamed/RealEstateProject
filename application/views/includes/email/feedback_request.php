...
<html>
    <head>
        <title>SHARE B&A EXPERIENCE</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            <table border="0" align="left" cellpadding="5" cellspacing="0" width="400px" style="overflow: visible;">
                <tr>
                    <td bgcolor='#333333' colspan='2' height='52'><p style='font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#2d8af4; margin-left:11px'>SHARE B&A EXPERIENCE</p></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    <td bgcolor='#666666' height='40'>
                        <p style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF; font-weight:bold; margin-left:11px'><strong> Agent:</strong></p>
                    </td>
                    <td bgcolor='#666666' height='40'>
                        <p style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF; font-weight:bold;'><?php echo $agent; ?></p>
                    </td>
                </tr>
                 <tr>
                    <td bgcolor='#666666' height='40'>
