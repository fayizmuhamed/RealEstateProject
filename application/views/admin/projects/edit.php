<div class="main-area">
    ...
    <div class="add-new-form">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m6">
                <input id="project_priority" type="number" name="project_priority"  class="validate" value="<?php echo set_value('project_priority', isset($project['project_priority'])?$project['project_priority']:''); ?>">
                    ...
                    <div class="collapsible-body pads">
                        <div class="row">
                            ...
                            foreach ($navigations as $key => $value) {
                                ...
                                echo '<input type="checkbox" class="navigation" value="1" name="navigations[' . $key . ']" id="' . $value . '" ' . set_checkbox('navigations', "1", (!empty($project_navigations) && isset($project_navigations[$value]) ) ? TRUE : FALSE) . ' />';
