    ...
    <div class="add-new-form">
        ...
        <div class="row">
            <div class="input-field col s6">
                <input id="project_name" type="text" name="community_name" class="validate" value="<?php echo set_value('community_name',$community[0]['community_name']); ?>">
                <label class="active" for="community_name">Community Name</label>
                 <input type="hidden" id="community_id" name="community_id" value="<?php echo $community[0]['community_id']; ?>"/>
            </div>
            <div class="input-field col s6">
        ...
        <div class="row">
            <div class="input-field col s12">
                <textarea id="community_description" class="materialize-textarea" name="community_description" ><?php echo set_value('community_description',$community[0]['community_description']); ?></textarea>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input id="community_location_url" type="text" name="community_location_url"  class="validate" value="<?php echo set_value('community_location_url',$community[0]['community_location_url']); ?>">
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                <input id="community_dis_from_metro" type="number" name="community_dis_from_metro"  class="validate" value="<?php echo set_value('community_dis_from_metro',$community[0]['community_dis_from_metro']); ?>" step="any">
                <label class="active" for="community_dis_from_metro">Distance from metro</label>
            </div>
            <div class="input-field col s6">
                <input id="community_dis_from_public_transport" type="number" name="community_dis_from_public_transport"  class="validate" value="<?php echo set_value('community_dis_from_public_transport',$community[0]['community_dis_from_public_transport']); ?>" step="any">
        ...
        <div class="row">
            <div class="file-field input-field col s6">
                <div class="btn normal-bt">
                    ...
                    <input type="hidden" id="community_cover_image_hidden" name="community_cover_image_hidden" value="<?php echo $community[0]['community_cover_image']; ?>"/>
                </div>
                <div class="file-path-wrapper">
                    <input class="file-path validate image-upload-text" type="text" placeholder="Upload cover image" value="<?php echo $community[0]['community_cover_image']; ?>">
