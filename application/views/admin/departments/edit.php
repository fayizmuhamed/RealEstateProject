...
<div class="main-area">
    ...
    <div class="add-new-form">
        ...
        ?>
        <?php echo form_open('admin/departments/update/'.$this->uri->segment(4).''); ?>

        <!-- Project Name Developer -->
        <div class="row">
            <div class="input-field col s6">
                <input id="emp_name" type="text" name="dep_name" class="validate" value="<?php echo set_value('dep_name', $department['dep_name']); ?>">
