    ...
    <!--                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d462566.5898229724!2d54.947228699020094!3d25.07471674873841!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e5084295162!2sDubai!5e0!3m2!1sen!2sae!4v1499253569396" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            ...
            <div class="col s12 l12 m12">
                <div class="row agent-det mg-bt-none">
                    <div class="col s12 l12 m12">
                        <h2>Other properties for sales in  <?php echo (isset($property->property_community) ? $property->property_community : ''); ?></h2>
                    </div>
                    <div id="buy_detail_property_list_container">
                        <?php
                    ...
                    <div class="col s12 more-button-block">
                        ...
                        <button class="bt-normal waves-effect waves-light" id="btn_buy_detail_property_list_add_more" data-page="1" data-community="<?php echo (isset($property->property_community) ? $property->property_community : ''); ?>" data-property="<?php echo (isset($property->property_id) ? $property->property_id : ''); ?>">VIEW MORE</button>
                    </div>
                </div>
            </div>
